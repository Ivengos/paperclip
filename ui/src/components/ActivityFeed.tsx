    ...
    <div>
      ...
      >
        ...
        <span className="flex-1 min-w-0 truncate">
          <span data-fc="actor" className="font-medium text-[var(--paperclip-activity-muted)] group-hover:text-white">{actorName}</span>
          <span data-fc="verb" className="ml-1 text-[var(--paperclip-activity-muted)]">made {group.events.length} updates to</span>
          <span data-fc="title" className="ml-1 text-[var(--paperclip-activity-muted)] group-hover:text-white">{entityName ?? group.entityId}</span>
        </span>
