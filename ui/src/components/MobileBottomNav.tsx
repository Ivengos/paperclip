...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  return (
    <nav
      className={cn(
        "fixed bottom-0 left-0 right-0 z-30 border-t border-border bg-background/95 transition-transform duration-200 ease-out md:hidden pb-[env(safe-area-inset-bottom)]",
