...
export function SkillDetailPage({
  ...
  return (
    <div className="min-h-[calc(100vh-12rem)]">
      ...
      {isDirty ? (
        <div className="fixed bottom-6 left-1/2 z-40 flex -translate-x-1/2 items-center gap-3 rounded-full border border-border bg-background px-4 py-2 shadow-lg">
